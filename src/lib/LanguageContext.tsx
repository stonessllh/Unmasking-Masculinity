...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'showcase.delete_btn': 'Delete Project',
    'showcase.delete_confirm': 'Are you sure you want to delete this showcase item?',
  ...
  zh: {
    ...
    'showcase.delete_btn': '删除项目成果',
    'showcase.delete_confirm': '您确定要删除此项成果吗？',
